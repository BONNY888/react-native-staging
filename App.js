    ...
    getLocation() {
        Geolocation.getCurrentPosition(
            location => {
                ...
                this.setState(previousState => ({ location: coords }))
            },
            error => {
                Alert.alert("定位失敗：" + error)
            }
        );
    }
    ...
    render() {
        ...
        const footer = <View
            ...
            >
                ...
                <Text style={styles.footer_nav_text}>臨打報名</Text>
            </TouchableOpacity>
            <TouchableOpacity
                style={styles.footer_nav_content}
                onPress={()=> {
            ...
            >
                ...
                <Text style={styles.footer_nav_text}>開團找我</Text>
            </TouchableOpacity>
            <TouchableOpacity
                style={styles.footer_nav_content}
                onPress={()=> {
            ...
            >
                ...
                <Text style={styles.footer_nav_text}>羽球知識家</Text>
            </TouchableOpacity>
            {/*
            <TouchableOpacity
                style={styles.footer_nav_content}
            ...
            >
                ...
                <Text style={styles.footer_nav_text}>Live直播</Text>
            </TouchableOpacity>
            */}
            <TouchableOpacity
            ...
            >
                ...
                <Text style={styles.footer_nav_text}>My Bonny</Text>
            </TouchableOpacity>
        </View>;
